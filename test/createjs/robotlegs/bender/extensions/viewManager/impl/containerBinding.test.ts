...
describe("ContainerBinding", () => {
    ...
    it("parent_is_stored", () => {
        let parentContainer: createjs.Container = new createjs.Container();
    ...
    it("handler_is_invoked", () => {
        ...
        binding.handleView(container, <IClass<any>>createjs.Container.constructor);
        assert.equal(callCount, 1);
    });

    it("handler_is_passed_correct_details", () => {
        const expectedView: createjs.Container = container;
        const expectedType: IClass<any> = <IClass<any>>createjs.Container.constructor;
        let actualView: createjs.Container = null;
